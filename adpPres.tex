...
data
\item<6-> Tasks: species identification, species detection, information
retrieval
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item T. Berg et. al., ``POOF: Part-based one-vs-one features for fine-grained categorization, face verification, and attribute estimation'', CVPR 2013.
	\item L. Xie et. al., ``Hierarchical part matching for fine-grained categorization'', ICCV 2013.
	\item B. Yao et. al., ``A codebook-free and annotation-free approach for fine-grained image categorization'', CVPR 2012.	
	\end{itemize}	
	\begin{figure}
	\begin{tabular}{c c c c}
	\only<3->{\includegraphics[height=2.5cm]{figures/collage.png}&
	\includegraphics[height=1.5cm]{figures/bird_points2.png}&
	\includegraphics[height=1cm]{figures/bird_points.png}&
	\includegraphics[height=1cm]{figures/bird_templates.png}}
	\end{tabular}
	\end{figure}
	\scriptsize
	\item<4-> Visual guidance: T. Berg et. al., ``How do you tell a
...
\item Online bird classification portal (image, sound, semantics)
\end{itemize}
\end{itemize}
\end{frame}
