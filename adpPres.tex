...
\begin{itemize}
	...
	\end{tabular}
	\end{figure}
	\item<4-> Visual guidance: T. Berg and P. Belhumeur, ``How do you tell a blackbird from a crow,'' ICCV 2013.
	\item<5-> Detection: D. Song and Y. Xu, ``A monocular vision-based low false negative filter for assisting the search for rare bird species using a probable observation data set-based EKF method'', Trans. Image Processing, 2010.	
\begin{figure}
\begin{tabular}{c c}
