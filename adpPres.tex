...
<<<<<<< HEAD
	\item<11-> Intra-class variations: Changes in pose, motion, light conditions.
=======
...
=======
	\item T. Berg and P. Belhumeur, ``POOF: Part-based one-vs-one features for 
	fine-grained categorization, face verification, and attribute estimation'',
	CVPR 2013.
	\item B. Yao et. al., ``A codebook-free and annotation-free approach for
	fine-grained image categorization'', CVPR 2012.
	\item L. Xie et. al., ``Hierarchical part matching for fine-grained visual
	categorization'', ICCV 2013.
>>>>>>> origin/master
	\end{itemize}	
	\begin{figure}
	\begin{tabular}{c c c}
